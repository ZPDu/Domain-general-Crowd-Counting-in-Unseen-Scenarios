...
def domain_split(dataset, model, device, cluster_before, filename, epoch, nmb_cluster=3, method='Kmeans', pca_dim=256, batchsize=32, num_workers=32, whitening=False, L2norm=False, instance_stat=True):
